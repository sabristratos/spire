...
export function timepickerComponent(config = {}) {
    return {
        ...
        minuteStep: config.minuteStep || TIMEPICKER_DEFAULTS.MINUTE_STEP,
        showSeconds: config.showSeconds || TIMEPICKER_DEFAULTS.SHOW_SECONDS,
        ...
        hour: TIMEPICKER_DEFAULTS.DEFAULT_HOUR_12,
        minute: TIMEPICKER_DEFAULTS.DEFAULT_MINUTE,
        second: TIMEPICKER_DEFAULTS.DEFAULT_SECOND,
        period: TIMEPICKER_DEFAULTS.DEFAULT_PERIOD,

        hourOptions: [],
        minuteOptions: [],
        secondOptions: [],
        periodOptions: TIMEPICKER_DEFAULTS.PERIOD_OPTIONS.map(p => ({ value: p, label: p })),
        ...
        parseInitialValue() {
            if (!this.value) {
                if (this.use24Hour === false) {
                    this.hour = TIMEPICKER_DEFAULTS.DEFAULT_HOUR_12;
                    this.period = TIMEPICKER_DEFAULTS.DEFAULT_PERIOD;
                } else if (this.use24Hour === true) {
                    this.hour = TIMEPICKER_DEFAULTS.DEFAULT_HOUR_24;
                } else {
                    this.hour = TIMEPICKER_DEFAULTS.DEFAULT_HOUR_12;
                    this.period = TIMEPICKER_DEFAULTS.DEFAULT_PERIOD;
                }
                this.minute = TIMEPICKER_DEFAULTS.DEFAULT_MINUTE;
                this.second = TIMEPICKER_DEFAULTS.DEFAULT_SECOND;
                return;
            }
