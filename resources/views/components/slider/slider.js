...
import { SLIDER_DEFAULTS } from '../../../js/shared/component-constants';

export function sliderComponent(config = {}) {
    return {
        mode: config.mode || SLIDER_DEFAULTS.MODE,
        min: config.min ?? SLIDER_DEFAULTS.MIN,
        max: config.max ?? SLIDER_DEFAULTS.MAX,
        step: config.step ?? SLIDER_DEFAULTS.STEP,
        disabled: config.disabled || false,
        readonly: config.readonly || false,
        showTooltip: config.showTooltip ?? SLIDER_DEFAULTS.SHOW_TOOLTIP,
        marks: config.marks || [],
